...
class URLShortener{
    ...
    function validate(){
        ...
        if(!empty($long_url)){
            ...
            if($insertData){
                return '<p style="text-align:center; font-weight:600;">
                Votre URL raccourcie:<br />' 
            ...
            return '<p style="text-align:center;">Merci de remplir le champ!</p>';
        }
            ...
            <div class="form_block">
                ...
                <div class="body">'.
                    ...
                    .'<form action="?action=validate" method="POST">
                        <input type="text" name="long_url" placeholder="Entrez ou copiez votre URL.." required />
